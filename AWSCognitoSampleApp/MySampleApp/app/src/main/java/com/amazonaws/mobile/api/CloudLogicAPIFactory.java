...
public class CloudLogicAPIFactory {
    ...
    public static CloudLogicAPIConfiguration[] getAPIs() {
        final CloudLogicAPIConfiguration[] apis = new CloudLogicAPIConfiguration[] {
                new CloudLogicAPIConfiguration("UserAndClass",
                                              "Action for User and Class",
                                              "https://jk9qys1cb9.execute-api.us-east-1.amazonaws.com/Development",
                                              new String[] {
                                                  "/items",
                                                  "/items/123",
                                              },
                                              com.amazonaws.mobile.api.idjk9qys1cb9.UserAndClassMobileHubClient.class),
        };
